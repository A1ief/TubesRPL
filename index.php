...
<head>
  ...
  <!-- Favicons -->
  <link href="HalamanUtama/assets/img/favicon.png" rel="icon">
  <link href="HalamanUtama/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="HalamanUtama/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="HalamanUtama/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="HalamanUtama/assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="HalamanUtama/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
  <link href="HalamanUtama/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="HalamanUtama/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">

  <!-- Main CSS File -->
  <link href="HalamanUtama/assets/css/main.css" rel="stylesheet">
</head>
...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section light-background">
      ...
      <img src="HalamanUtama/assets/img/hero-bg.jpg" alt="" data-aos="fade-in">
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
              <div class="team-member d-flex align-items-start">
                ...
                <div class="member-info">
                  <h4>Fatmi S.kep</h4>
                  <span>Perawat Klinik Dian Kusuma Wijaya</span>
                </div>
              </div>
            </div><!-- End Team Member -->
  ...
  <footer id="footer" class="footer light-background">
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <span class="sitename">Sosial Media Klinik Dian Kusuma Wijaya</span>
          </a>
          <div class="footer-contact pt-3">
            <p><strong> Klinik: </strong>Klinik Dian Kusuma Wijay</p>
            <p><strong> Alamat </strong>Jalan Kusmanaji No. 40, Dusun Suko, Desa Sumberpucung, Kecamatan Sumberpucung, Kabupaten Malang, Jawa Timur 65165, Indonesia.</p>
            <p class="mt-3"><strong>Telpon:</strong> <span>0822-3383-6382</span></p>
            <p><strong>Email:</strong> <span>klinikdiankusumawijaya@gmail.com</span></p>
          </div>
      ...
      <div class="container copyright text-center mt-4">
        <p>© <span>Media</span> <strong class="px-1 sitename">Klinik Dian Kusuma Wijaya</strong> <span>All Rights Reserved</span></p>
        <div class="credits">
          <!-- All the links in the footer should remain intact. -->
          <!-- You can delete the links only if you've purchased the pro version. -->
          <!-- Licensing information: https://bootstrapmade.com/license/ -->
          <!-- Purchase the pro version with working PHP/AJAX contact form: [buy-url] -->
          Designed by <a href="https://bootstrapmade.com/">Maya Via Agustin Rahayu</a>
        </div>
      </div>
  ...
  <!-- Vendor JS Files -->
  <script src="Halamanutama/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="Halamanutama/assets/vendor/php-email-form/validate.js"></script>
  <script src="Halamanutama/assets/vendor/aos/aos.js"></script>
  <script src="Halamanutama/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="Halamanutama/assets/vendor/purecounter/purecounter_vanilla.js"></script>
  <script src="Halamanutama/assets/vendor/swiper/swiper-bundle.min.js"></script>

  <!-- Main JS File -->
  <script src="Halamanutama/assets/js/main.js"></script>
