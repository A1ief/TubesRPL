...
$grafikResult = $koneksi->query($grafikQuery);
...
while ($row = $grafikResult->fetch_assoc()) {
    ...
    $totalGrafik[] = $row['total'];
}

// Query 1: Hitung jumlah pasien
$result_pasien = $koneksi->query("SELECT COUNT(*) as total_pasien FROM tbl_pasien");
$data_pasien = $result_pasien->fetch_assoc();

// Query 2: Hitung jumlah dokter
$result_dokter = $koneksi->query("SELECT COUNT(*) as total_dokter FROM tbl_dokter");
$data_dokter = $result_dokter->fetch_assoc();

// Query 3: Hitung total pembayaran (jumlahkan seluruh total_pembayaran)
$result_pembayaran = $koneksi->query("SELECT SUM(total_pembayaran) as total_pembayaran FROM tbl_pembayaran");
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="layouts/pasien/index.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Pasien</span></a>
            </li>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Mohammad alif</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="dashboard_excel.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Pasien</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $data_pasien['total_pasien']; ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Dokter</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $data_dokter['total_dokter']; ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?= number_format($data_pembayaran['total_pembayaran']); ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Total Obat</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $data_obat['total_obat']; ?></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header bg-primary text-white">
                                        <strong>Grafik Total Pembayaran per Tanggal</strong>
                                    </div>
                                    <div class="card-body">
    ...
    <script>
        ...
        const chart = new Chart(ctx, {
            type: 'line',
            data: {
                labels: <?= json_encode($tanggalGrafik); ?>,
                datasets: [{
